...
__global__ void assofixp2c_cuda_kernel(int b, int n, int m, int ks, int nsample, const int *__restrict__ idx_c, const int *__restrict__ cid, int *__restrict__ idx) {
...
void assofixp2c_cuda_launcher(int b, int n, int m, int ks, int nsample, const int *idx_c, const int *cid, int *idx,    cudaStream_t stream) {
    ...
    assofixp2c_cuda_kernel<<<blocks, threads, 0, stream>>>(b, n, m, ks, nsample, idx_c, cid, idx);
